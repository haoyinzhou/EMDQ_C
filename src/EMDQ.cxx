...
bool EMDQSLAM::CEMDQ::InputMatchingDataFromOpenCV(const std::vector< std::vector<double> >* coord1, const std::vector< std::vector<double> >* coord2
	, const std::vector< cv::DMatch >* matches)
{
	if (matches->size() == 0) return false;
	int D = (int)coord1->at(0).size();
